...
export const Header = ()=> {
    let search: HTMLInputElement, list: any, removeButton: any
    ...
    const handleSearch = () =>{
        ...
        if (list !== null) {
            list.style.display = 'flex'
            list.innerHTML += `<div id="search_list-item">${cache}<div id='remove_button'><svg xmlns="http://www.w3.org/2000/svg" height="20" width="20"><path d="M6.062 15 5 13.938 8.938 10 5 6.062 6.062 5 10 8.938 13.938 5 15 6.062 11.062 10 15 13.938 13.938 15 10 11.062Z"/></svg></div></div>`
        }
        list.style.display = 'none'
    }
            ...
            <header className="site-header">
                <div className="wrapper site-header__wrapper">
                    ...
                    <div className='search' id='#search'>
                        <input ref={rootEl} autoComplete="off" type="text" placeholder="Искать здесь..." id='search_input' onFocus={onFocusHandler} onChange={(event)=>handlerChange(event)}/>
                        <div id='search_list'>
                            {
                                // @ts-ignore
                                cache2.map(item => (
